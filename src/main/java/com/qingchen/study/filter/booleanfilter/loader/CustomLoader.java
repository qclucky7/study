package com.qingchen.study.filter.booleanfilter.loader;
...
public class CustomLoader<S>
        implements Iterable<S>
{

    private static final String PREFIX = "META-INF/services/test/";
    ...
    private CustomLoader(Class<S> svc, ClassLoader cl) {
     ...
     */
    public static <S> CustomLoader<S> load(Class<S> service,
                                                      ClassLoader loader)
    {
        return new CustomLoader<>(service, loader);
    }
    ...
    public static <S> CustomLoader<S> load(Class<S> service) {
        ...
        return CustomLoader.load(service, cl);
    }
