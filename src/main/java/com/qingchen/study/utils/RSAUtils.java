...
public class RSAUtils {
    ...
    public static final String RSA_ALGORITHM_FOR_WECHAT = "RSA/ECB/OAEPWITHSHA-1ANDMGF1PADDING";
    ...
    public static PublicKey getPublicKey(InputStream inputStream, String keyAlgorithm) throws Exception {
        try
        {
            ...
            X509EncodedKeySpec pubX509 = new X509EncodedKeySpec(Base64Util.decode(sb.toString()));
     ...
     * @return
     */
    public static String publicEncryptForWechat(String data, RSAPublicKey publicKey) {
        try {
            Cipher cipher = Cipher.getInstance(RSA_ALGORITHM_FOR_WECHAT);
            cipher.init(Cipher.ENCRYPT_MODE, publicKey);
            return Base64.encodeBase64URLSafeString(rsaSplitCodec(cipher, Cipher.ENCRYPT_MODE, data.getBytes(CHARSET), publicKey.getModulus()
                    .bitLength()));
        } catch (Exception e) {
