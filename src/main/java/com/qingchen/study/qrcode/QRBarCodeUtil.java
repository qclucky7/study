package com.qingchen.study.qrcode;
...
public class QRBarCodeUtil {
    ...
    public static void createCodeToFile(String codeContent, File codeImgFileSaveDir, String fileName) {
        try {
            ...
            BitMatrix bitMatrix =
                    multiFormatWriter.encode(codeContent, BarcodeFormat.QR_CODE, CODE_WIDTH, CODE_HEIGHT, hints);
    ...
    public static void main(String[] args) throws MalformedURLException {
        createCodeToFile("wangchen", new File("D:\\"),"1.jpeg");
    }
}