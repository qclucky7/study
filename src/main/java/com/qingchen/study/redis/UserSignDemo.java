...
/**
 * @ClassName UserSignDemo
 * @description:
 * @author: WangChen
 * @create: 2020-04-19 14:49
 **/
public class UserSignDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("15<<" + (15 >> 1 << 1));
        { // doSign
            boolean signed3 = demo.doSign(1000, LocalDate.of(2020, 4, 16));
            boolean signed1 = demo.doSign(1000,  LocalDate.of(2020, 4, 17));
            boolean signed2 = demo.doSign(1000, LocalDate.of(2020, 4, 18));
